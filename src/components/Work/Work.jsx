...
const Work = () => {
	...
	return (
		<section id='work' className=' py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans relative bg-work-gradient'>
			{/* Titulo  */}
			<div className='text-center mb-16'>
				<h2 className='text-4xl font-bold text-white'>PROJETOS</h2>
				<div className='w-32 h-1 bg-[#4571ec] mx-auto mt-4'></div>
				<p className='text-gray-400 mt-4 text-lg font-semibold'>Uma apresentação dos projetos em que trabalhei, destacando as minhas competências e experiência em diversas tecnologias.</p>
			</div>
			...
			<div className='grid gap-12 grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
				{projects.map(project => (
					<div
						...
						className='border border-white bg-gray-900 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden cursor-pointer hover:shadow-[#4571ec] hover:-translate-y-2 transition-transform duration-300'
					>
						<div className='p-4'>
