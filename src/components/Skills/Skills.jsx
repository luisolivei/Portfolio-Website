...
const Skills = () => (
	<section id='skills' className='mt-28 py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans bg-skills-gradient'>
		{/* Titulo */}
		<div className='text-center mb-8'>
			<h2 className='text-3xl sm:text-4xl font-bold text-white'>SKILLS</h2>
			<div className='w-24 h-1 bg-[#4571ec] mx-auto mt-2'></div>
			<p className='text-gray-400 mt-4 text-lg font-semibold'>Uma coleção das minhas competências técnicas e especialização, desenvolvidas ao longo de diversos projetos e percursos académicos</p>
		</div>
